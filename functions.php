...
function initium_setup() {
  ...
  // custom headers. See initium_admin_header_style(), below.
  add_custom_image_header( 'initium_header_style', 'initium_admin_header_style', 'initium_admin_header_image' );
  ...
  register_default_headers( array(
    'wheel' => array(
      ...
      'description' => __( 'Wheel', 'initium' )
    ),
    'shore' => array(
      'url' => '%s/images/headers/shore.jpg',
      'thumbnail_url' => '%s/images/headers/shore-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Shore', 'initium' )
    ),
    'trolley' => array(
      'url' => '%s/images/headers/trolley.jpg',
      'thumbnail_url' => '%s/images/headers/trolley-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Trolley', 'initium' )
    ),
    'pine-cone' => array(
      'url' => '%s/images/headers/pine-cone.jpg',
      'thumbnail_url' => '%s/images/headers/pine-cone-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Pine Cone', 'initium' )
    ),
    'chessboard' => array(
      'url' => '%s/images/headers/chessboard.jpg',
      'thumbnail_url' => '%s/images/headers/chessboard-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Chessboard', 'initium' )
    ),
    'lanterns' => array(
      'url' => '%s/images/headers/lanterns.jpg',
      'thumbnail_url' => '%s/images/headers/lanterns-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Lanterns', 'initium' )
    ),
    'willow' => array(
      'url' => '%s/images/headers/willow.jpg',
      'thumbnail_url' => '%s/images/headers/willow-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Willow', 'initium' )
    ),
    'hanoi' => array(
      'url' => '%s/images/headers/hanoi.jpg',
      'thumbnail_url' => '%s/images/headers/hanoi-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Hanoi Plant', 'initium' )
    )
  ) );
}
endif; // initium_setup

if ( ! function_exists( 'initium_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @since Initium 1.0
 */
function initium_header_style() {
...
endif; // initium_header_style

if ( ! function_exists( 'initium_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * Referenced via add_custom_image_header() in initium_setup().
 *
 * @since Initium 1.0
 */
function initium_admin_header_style() {
?>
  <style type="text/css">
...
endif; // initium_admin_header_style

if ( ! function_exists( 'initium_admin_header_image' ) ) :
/**
 ...
 * @since Initium 1.0
 */
function initium_admin_header_image() { ?>
  <div id="headimg">
    <?php
...
<?php }
endif; // initium_admin_header_image
